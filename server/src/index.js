...
import driverVerificationRouter from './routes/driver.verifications.js';
...
app.use('/api/admin', auth, requireRoles('admin', 'analyst'), adminDriversRouter);
app.use('/api/industry', auth, requireRoles('admin', 'analyst'), industryUpdatesRouter);
app.use('/api/driver', auth, requireRoles('driver'), driverVerificationRouter);
